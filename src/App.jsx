...
import { Text3D, Loader, PresentationControls, Center, Environment, ContactShadows } from '@react-three/drei'
...
function App() {
  ...
  return (
    <>
      <div id="canvas">
        <Canvas shadows camera={{ position: [0, 0, 4], fov: 25 }} style={{ background: '#282828' }} >
